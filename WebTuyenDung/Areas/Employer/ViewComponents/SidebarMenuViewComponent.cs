...
namespace WebTuyenDung.Areas.Employer.ViewComponents
{
    public class SidebarMenuViewComponent : ViewComponent
    {
        ...
        {
            var waitForApprovalRecruimentNewsCount = dbContext.RecruimentNews.DeferredCount(e => !e.IsApproved).FutureValue();
            var waitForApprovalPostsCount = dbContext.Posts.DeferredCount(e => !e.IsApproved).FutureValue();
